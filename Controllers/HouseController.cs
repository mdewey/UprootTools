...
namespace UprootTools.Controllers
{
  ...
  public class HouseController : ControllerBase
  {
    ...
    public HouseController(DatabaseContext context, IConfiguration config)
    {
      _context = context;
    ...
    {
      return await _context.Houses.Where(w => w.Latitude != 0 && w.Longitude != 0).ToListAsync();
    }
    ...
    public async Task<ActionResult<House>> PostHouse(House house)
    {
      ...
      var resp = await client.GetAsync($"https://api.mapbox.com/geocoding/v5/mapbox.places/{house.Address}.json?access_token={this._MAPBOX_TOKEN}");
      ...
      house.Latitude = lat.GetDouble();
      house.Longitude = lng.GetDouble();
